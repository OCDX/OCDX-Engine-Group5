                ...
                <div class="container">
                        ...
                        <?php
                                if(isset($_POST['submit'])) { // Was the form submitted?
                                        ...
                                        $sql = "INSERT INTO swedb.user(userid, email,hashed_password,usertype,gender,jobtitle,org,edevel,fname,lname,city,state,zip,country,$
                                         if ($stmt = mysqli_prepare($dbconnect, $sql)) {
                                                ...
                                                pg_stmt_bind_param($stmt, "sssdssssssssssss", $email,$fname,$lname,$userid,$usertype,$gender,$jobtitle,$org,$edlevel,$city,$$
